...
void main()
{
    ...
    vec3 halfwayDir = normalize(u_cameraPosition.xyz + u_lightPosition.xyz);
    vec4 specularColor = u_specularColor * u_specularMaterial * pow(max(0.0, dot(v_normal, halfwayDir)), u_shininess);
